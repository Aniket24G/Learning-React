...
export default function Card() {
    ...
    return (
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="/">
                <img className="p-4 rounded-full" src={data.avatar_url} alt="product_image1" />
            </a>
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <a href='https://www.linkedin.com/in/aniket-g246/' target='_blank'>
                    <svg className="w-4 h-4 mr-1 "
                        aria-hidden="true" 
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 448 512">
                    ...
                    <a href="https://www.instagram.com/aniketg_24/" target='_blank'>
                    <svg className="w-4 h-4 mr-1 "
                        aria-hidden="true" 
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
